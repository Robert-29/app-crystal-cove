...
export default function Home() {
    ...
    const scrollGallery = (direction) => {
        if (galleryRef.current) {
            const itemWidth = 272; // w-64 (256) + mr-4 (16)
            if (direction === 'left') {
        ...
        <ScrollView className="flex-1 bg-white" showsVerticalScrollIndicator={false}>
            ...
            <View className="py-10 bg-gray-50 items-center relative">
                ...
                <View className="w-full relative">
                    <ScrollView 
                        ...
                        className="w-full pl-4 flex-row"
                        onScroll={(e) => {
                            scrollPosition.current = e.nativeEvent.contentOffset.x;
                        }}
                        scrollEventThrottle={16}
                    >
                        <Image source={{ uri: 'https://images.unsplash.com/photo-1611892440504-42a792e24d32?auto=format&fit=crop&w=400&q=80' }} className="w-64 h-48 rounded-xl mr-4" />
                        <Image source={{ uri: 'https://images.unsplash.com/photo-1522771731478-44fb10e9a48f?auto=format&fit=crop&w=400&q=80' }} className="w-64 h-48 rounded-xl mr-4" />
                        <Image source={{ uri: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=400&q=80' }} className="w-64 h-48 rounded-xl mr-4" />
                        <Image source={{ uri: 'https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?auto=format&fit=crop&w=400&q=80' }} className="w-64 h-48 rounded-xl mr-4 pr-4" />
                    </ScrollView>

                    {/* Flechas de navegación */}
                    <TouchableOpacity 
                        onPress={() => scrollGallery('left')}
                        className="absolute left-2 top-24 bg-white/80 rounded-full p-2 shadow-sm"
                    >
                    ...
                    <TouchableOpacity 
                        ...
                        className="absolute right-2 top-24 bg-white/80 rounded-full p-2 shadow-sm"
                    >
            ...
            <View className="py-10 bg-gray-50 items-center px-4">
                ...
                <View className="w-full bg-white rounded-xl p-6 shadow-sm border border-gray-100 items-center">
                    ...
                    <Text className="text-center text-xs text-gray-500">robert292005@gmail.com{`\n`}roberto.29.2005.h@gmail.com</Text>
                </View>
            </View>
